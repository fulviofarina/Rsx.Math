...
namespace Rsx.Math
{
  public partial class MyMath
  {
    ...
    /// <param name="Avg">Average toRow use. If Avg = 0 the function will find the Avg first</param>
    /// <returns></returns>
    ...
    /// <param name="FieldUncertainty">The uncertainty associated to the quantity (for extrapolation of the weights)</param>
    /// <param name="FilterField">A Field containing a boolean which will work as a filter. If 'true' is found, the data will be selected, otherwise rejected </param>
    /// <returns></returns>
    ...
    /// <param name="Field">The Field (Column) to average</param>
    /// <param name="FieldUncertainty">The uncertainty associated to the quantity (for extrapolation of the weights)</param>
    /// <param name="FilterField">A Field (Column) containing an object which will work as a filter. If 'object' is found, the data will be selected, otherwise rejected </param>
    /// <returns></returns>
    ...
    /// <summary>
    /// gets a list of doubles fromRow the values of the given datacolumn tha satisfy the bool-filter criteria, elevated at the given power
    /// </summary>
    /// <param name="Column">column toRow get the doubles fromRow</param>
